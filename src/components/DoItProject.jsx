...
const DoItProject = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Content Reveal
            const sections = gsap.utils.toArray('.doit-section');
            ...
            // Feature Cards Hover/Scroll Animation
    ...
    return (
        <div className="doit-project-container" ref={containerRef}>
            ...
            <section className="doit-content">
                ...
                <div className="doit-section doit-tech-stack">
                    <h2 className="section-title">Technical Foundation</h2>
                    <div className="tech-content">
                        <div className="tech-column">
                            <h3>Frontend</h3>
                            <div className="tech-item">React Native (v0.81.5)</div>
                            <div className="tech-item">Expo SDK (~54.0.23)</div>
                            <div className="tech-item">React Navigation</div>
                            <div className="tech-item">React Hook Form + Zod</div>
                            <div className="tech-item">Reanimated</div>
                        </div>
                        <div className="tech-column">
                            <h3>Backend</h3>
                            <div className="tech-item">Supabase (PostgreSQL)</div>
                            <div className="tech-item">Real-time Sync</div>
                            <div className="tech-item">Row-level Security</div>
                            <div className="tech-item">Edge Functions</div>
                        </div>
                        <div className="tech-column">
                            <h3>Architecture</h3>
                            <div className="tech-item">Offline-first (AsyncStorage)</div>
                            <div className="tech-item">Optimistic UI Updates</div>
                            <div className="tech-item">Custom Context Providers</div>
                            <div className="tech-item">Agile Sprints</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="doit-section doit-next">
                    <h2>Next Project</h2>
                    <p>Vanguard Fintech</p>
                </div>
            </section>
        </div>
    );
